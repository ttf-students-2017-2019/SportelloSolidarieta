...
CREATE TABLE MEETING (ID BIGINT AUTO_INCREMENT NOT NULL, AMOUNT DECIMAL(38,2), DATE DATE, DESCRIPTION LONGTEXT, FDELETED TINYINT(1) default 0, PERSON_ID BIGINT, PRIMARY KEY (ID))
