CREATE TABLE APPOINTMENT (id_appuntamento INTEGER AUTO_INCREMENT NOT NULL, data_ora_appuntamento DATETIME, durata INTEGER, f_effettuato TINYINT(1) default 0, id_assistito BIGINT, PRIMARY KEY (id_appuntamento))
CREATE TABLE MEETING (ID BIGINT AUTO_INCREMENT NOT NULL, AMOUNT FLOAT, DATE DATE, DESCRIPTION VARCHAR(255), PERSON_ID BIGINT, PRIMARY KEY (ID))
